...
const BusinessSummery = () => {
    return (
        <div style={{
            ...
            <div className="shadow grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 pt-12">
                <div className='text-center'>
                    ...
                    <div className="stat-desc font-bold">WE SERVED CUSTOMERS</div>
                </div>
                ...
                <div className='text-center'>
                    ...
                    <div className="stat-desc font-bold">ANNUAL REVENUE</div>
                </div>
                ...
                <div className='text-center'>
                    ...
                    <div className="stat-desc font-bold">TOOLS (14%)</div>
                </div>
                <div className='text-center'>
                    <div className="stat-figure text-secondary">
                    ...
                    <h3 className=" pt-2 font-bold">Reviews</h3>
                </div>
