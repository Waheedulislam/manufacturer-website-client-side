                ...
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='px-16'>
                        ...
                        <div className="card w-full mt-12 bg-base-100 shadow-xl ">
                            <div className="card-body ">
                                <h2 className="text-2xl font-bold pb-2 text-center text-primary">Order Confirm</h2>
                                <div className='lg:pl-14'>
                                    ...
                                    <form onSubmit={handleNewItem}>
                                        ...
                                        <div className='pl-20'>
                                            <div className="form-control w-full max-w-xs">
                                                ...
                                                <label className="label">
                                                    <span className="label-text font-bold pl-10 text-primary">Quantity</span>
                                                </label>
                                        ...
                                        <div className="form-control pb-3 text-center w-full max-w-xs">
                                            <input type="text" name='name' placeholder="Name" readOnly value={user.displayName} className="input input-bordered w-full max-w-md " />
                                        </div>
                                        {/* email */}
                                        <div className="form-control pb-3 text-center w-full max-w-xs">
                                            <input type="email" value={user.email} readOnly name='email' placeholder="Email Address" className="input input-bordered w-full max-w-xs" />
                                        </div>
                                        {/* address  */}
                                        <div className="form-control pb-3 text-center w-full max-w-xs">
                                            <input type="text" autoComplete='off' name='address' required placeholder="Address" className="input input-bordered w-full max-w-xs" />
                                        </div>
                                        {/* phone  */}
                                        <div className="form-control pb-3 text-center w-full max-w-xs">
                                        ...
                                        <input type="submit" className="sm:w-56 ml-8 w-8/12 text-center btn btn-primary" value="Submit Information" />
                                    </form>
                                </div>
                            </div>
                        </div>
