...
const Payment = () => {
    ...
    const { data: orders, isLoading } = useQuery(['itemOrder', id], () => fetch(url, {
        method: 'GET',
        headers: {
            ...
            <div class="hero-content flex-col lg:flex-row-reverse">
                <div class="card w-50 max-w-md bg-base-100 shadow-xl">
                    <div class="card-body">
                        ...
                        <p className='font-bold'>Please pay: <span className='text-blue-500 font-bold'>${orders.price}</span></p>
                        <p className='font-bold'>Order Quantity: <span className='text-primary font-bold'>${orders.quantity}</span></p>
